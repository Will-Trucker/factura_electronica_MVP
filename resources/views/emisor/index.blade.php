                                ...
                                <div class="grid gap-4 mb-4 grid-cols-2">
                                    <div class="col-span-2">
                                        ...
                                        <input type="text" name="nombre" id="nombre"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" value="{{old('nombre')}}">
                                            @error('nombre')
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <input type="text" name="nombrecomercial" id="nombrecomercial"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" value="{{old('nombrecomercial')}}">
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <input type="email" name="correo" id="correo"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" value="{{old('correo')}}">
                                            @error('correo')
                                            <p class="text-red-600 mt-1 text-sm">{{ $message }}</p>
                                            @enderror
                                    </div>
                                    ...
                                    <div class="col-span-2 sm:col-span-1">
                                        ...
                                        <input type="text" name="NRC" id="NRC"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" value="{{'NRC'}}">
                                            @error('NRC')
                                            <p class="text-red-600 mt-1 text-sm">{{ $message }}</p>
                                            @enderror
                                    </div>
                                    <div class="col-span-2 sm:col-span-1">
                                        <label for="actividad"
                                            class="block mb-2 text-sm font-medium text-gray-900">Actividad
                                            Comercial</label>
                    ...
                    <tbody>
                        @foreach ($emisores as $emisor)
                            <tr
                                ...
                                <td class="px-6 py-4 text-center">
                                    {{-- <input type="button" value="Editar" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center btn-editEm" data-modal-target="crud-modal" data-modal-toggle="crud-modal">
                        <br><br>
                        <input type="button" value="Eliminar" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center btn-deleteEm"  data-modal-target="popup-modal" data-modal-toggle="popup-modal"> --}}
