    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow">
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                <h3 class="text-lg font-semibold text-gray-900">Editar Emisor</h3>
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-toggle="crud-modal_modificar{{$emisor['id']}}">
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2">
                        <label for="nombrecomercial"
                            class="block mb-2 text-sm font-medium text-gray-900">Nombre Comercial</label>
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="email" name="correo" id="correo"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 ase" value="{{$emisor['Correo']}}">
                            @error('correo')
                            <div class="text-red-600 mt-1 text-sm">{{ $message }}</div>
                            @enderror
                    </div>
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        <input type="text" name="NRC" id="NRC"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" value="{{$emisor['NRC']}}">
                            @error('NRC')
                            <div class="text-red-600 mt-1 text-sm">{{ $message }}</div>
                            @enderror
                    </div>
                    <div class="col-span-2 sm:col-span-1">
                        <label for="actividad"
                            class="block mb-2 text-sm font-medium text-gray-900">Actividad Comercial</label>
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea id="complemento" name="complemento" rows="4"
                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" >{{$emisor->Complemento}}</textarea>
                            @error('complemento')
                            <div class="text-red-600 mt-1 text-sm">{{ $message }}</div>
                            @enderror
                    </div>
