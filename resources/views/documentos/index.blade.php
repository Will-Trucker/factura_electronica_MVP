            ...
            <table class="w-full text-sm text-left rtl:text-right tabla-docs">
                ...
                <tbody>
                    ...
                    <tr
                        ...
                        <td class="px-6 py-4 text-center">
                            <a href="{{ route('getPDF', ['codGeneracion' => $documento->codigoGeneracion]) }}"
                                class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" target="_self">Ver
                                PDF</a>
                                <br>
                                <br>
                                <br>
                            ...
                            <a href="{{ route('verJson', ['codGeneracion' => $documento->codigoGeneracion]) }}"
                                class="w-full text-white bg-amber-400 hover:bg-amber-500 focus:ring-4 focus:outline-none focus:ring-amber-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" target="_self">Ver
                                JSON</a>
                                <br>
                                <br>
                                <br>
                            <a href="{{ route('mandarComprobantes', ['codGeneracion' => $documento->codigoGeneracion]) }}"
                                class="w-full text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" target="_self">Email</a>
                        </td>
                        @empty
                        <tr>
