...
<div class="container mx-auto p-6 ase">
    <div class="container mx-auto p-5 rounded-lg">
        <div class="relative overflow-x-auto">
            <h2 class="text-center text-white title-event1">EVENTO DE CONTINGENCIA</h2>
            <div class="flex justify-center" style="margin-top: 2rem">
               <a href="{{route('nuevoEContingencia')}}"class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2" type="button">Individual</a>
               <a href="{{route('lotesContingencia')}}"class="focus:outline-none text-white bg-amber-400 hover:bg-amber-400 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2" type="button">Lotes</a>
            </div>
        </div>
    </div>
